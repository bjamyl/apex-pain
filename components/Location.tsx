...
export default function Location() {
  ...
  return (
    <section className="m-4 md:m-8 lg:m-12 xl:m-16 2xl:m-20">
      <div className="relative h-96 lg:h-[700px] xl:h-[850px] lg:object-bottom w-full overflow-hidden rounded-2xl">
        <Image src={image} alt="percy-medical" fill className="object-cover object-center" />
