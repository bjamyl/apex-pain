...
export function PhysicianCard({ image, name, title, description }: PhysicianCardProps) {
  return (
    <div className="flex flex-col gap-6 lg:gap-8 mb-12 lg:mb-16">
      ...
      <div className="flex-1 text-center lg:text-left">
        <h3 className="text-xl sm:text-2xl lg:text-3xl xl:text-4xl font-bold text-defaultGreen mb-4 lg:mb-6">{name}</h3>
